...
func PrintVars() {
	...
	fmt.Println("DOCKERIZED" + " " + dockerized)
	fmt.Println("-------------------------------------------------")
	...
	fmt.Println("-------------------------------------------------")
	fmt.Println("AUTH_SERVICE" + " " + AUTH_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("CAMPAIGN_SERVICE" + " " + CAMPAIGN_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("CONTENT_SERVICE" + " " + CONTENT_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("INTERACTION_SERVICE" + " " + INTERACTION_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("MONOLIT_SERVICE" + " " + MONOLIT_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("PROFILE_SERVICE" + " " + PROFILE_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("REQUEST_SERVICE" + " " + REQUEST_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
	fmt.Println("SEARCH_SERVICE" + " " + SEARCH_SERVICE_URL)
	fmt.Println("-------------------------------------------------")
